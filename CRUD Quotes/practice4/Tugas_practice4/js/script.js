document.getElementById("beranda").onclick = function () {
  ...
  document.getElementById("alert").onclick = function () {
    window.alert("Selamat Datang Di Practice 4 Tavany Amalia Rizky");
  };
  
  document.getElementById("luasSegitiga").onclick = function () {
  ...
  document.getElementById("konversi").onclick = function () {
